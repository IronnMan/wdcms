...
<head>
    ...
    <link rel="stylesheet" href="https://responsive-navbar-with-dropdown.netlify.app/build/tailwind.css">
    <script src="https://cdn.jsdelivr.net/gh/alpinejs/alpine@v2.x.x/dist/alpine.min.js" defer></script>
    <title>Flowtrail UI Navigation Components</title>
</head>
<body class="antialiased bg-gray-100 dark-mode:bg-gray-900">
<div class="flex flex-col-reverse justify-between w-screen h-screen sm:block sm:relative" x-data="{ open: true }">
    <button @click="open = !open" class="block w-full px-4 py-2 text-gray-900 bg-white shadow-2xl sm:mr-4 sm:rounded-full sm:mb-4 sm:w-56 sm:right-0 sm:bottom-0 sm:absolute focus:outline-none focus:shadow-outline">
        <span x-show="open == true">Switch to Sidebar</span>
        <span x-show="open == false">Switch to Navbar</span>
    </button>
    <div x-show="open === true" class="w-full text-gray-700 bg-white dark-mode:text-gray-200 dark-mode:bg-gray-800">
    ...
    <div x-show="open === false" class="flex-col w-full md:flex md:flex-row md:min-h-screen">
