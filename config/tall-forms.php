...
return [
    ...
    'form-title' => "trans('create').' '.trans('crud.dummymodel.title_singular')",
    ...
    'select-placeholder' => 'select_placeholder', //'Please select an option...'
    'search-placeholder' => 'search_placeholder', //'Search ...' //used for both Search and SearchList fields
    'multiselect-placeholder' => 'multiselect_placeholder', //'Please select one or multiple options ...'
    'multiselect-help' => 'multiselect_help', //'Press CTRL(Windows) or CMD(Mac), to select/deselect multiple options.'


    //A Laravel blade component to wrap your form with, if $wrapWithView = true, see documentation
    'wrap-view-path' => 'layouts.form',
